                ...
                <div class="col-md-6">
                  <article class="entry">
                    <div class="entry-image mb-3">
                      <a href="<?php echo e($alias); ?>"><img style="height: 300px" src="<?php echo e($image); ?>" alt="<?php echo e($title); ?>"></a>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fhmagency/domains/fhmagency.vn/public_html/garage/resources/views/frontend/pages/service/category.blade.php ENDPATH**/ ?>